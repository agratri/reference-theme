...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'kindaid' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'kindaid' );

?>


<div class="tp-product-details-quantity">
	<div class="tp-product-quantity qty mb-15 mr-15">
		<?php
		/**
		...
		<input
			...
			aria-label="<?php esc_attr_e( 'Product quantity', 'kindaid' ); ?>"
