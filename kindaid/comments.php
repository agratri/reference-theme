...
function kindaid_move_comment_textarea_to_bottom($fields) {
...
add_action('comment_form_fields', 'kindaid_move_comment_textarea_to_bottom');
// comments for end 


// kindaid_comment_list
function kindaid_comment_list($comment, $args, $depth) {
