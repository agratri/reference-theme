...
<div class="tp-postbox-meta <?php echo esc_attr($is_single_meta); ?> ">
    
    <?php if($blog_meta_author_switch) : ?>
    <span><a href="<?php print esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) );?>"><img src="<?php echo esc_url( get_avatar_url( $user->ID ) ); ?>" alt=""> By <?php the_author(); ?></a></span>
     <?php endif; ?>
