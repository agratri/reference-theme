<?php
    ...
    $blog_cat_switch = get_theme_mod('blog_cat_switch', false);

    $categorie = get_the_category(); 
    $is_single_cat = is_single() ? 'position-static mb-20' : '';
?>

<?php if($blog_cat_switch) : ?>
<div class="tp-postbox-cat <?php echo esc_attr($is_single_cat); ?>">
    <a href="<?php echo get_category_link($categorie[0]->term_id); ?>">
        ...
        <?php echo esc_html($categorie[0]->name); ?>
    </a>
</div>
<?php endif; ?>