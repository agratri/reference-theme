<?php
class Kindaid_Event_Recent_Post extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'kindaid_event_recent_post',
            __('Kindaid Event Post With Thumb', 'kindaid'),
            array('description' => __('Display recent Event posts with thumbnails', 'kindaid'))
        );
        ...
        ?>
            <div class="tp-widget-post-list mb-15">
                ...
                <div class="tp-widget-post-content">
                    <span><i class="far fa-clock"></i> <?php echo esc_html(date( 'F j, Y', strtotime( $start_date ))); ?></span>
...
// REGISTER WIDGET
function kindaid_register_recent_event_post_widget() {
    register_widget('Kindaid_Event_Recent_Post');
}
add_action('widgets_init', 'kindaid_register_recent_event_post_widget');
