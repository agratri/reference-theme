...
class Kindaid_Footer_Info_Widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        <?php if (!empty($info)): ?>
            <p class="tp-footer-dec mb-30"><?php echo $info; // already sanitised with wp_kses_post() above ?></p>
        <?php endif; ?>
    ...
    public function form($instance) {
        ...
        <!-- Social URLs -->
        <p><label>Facebook URL:</label><input class="widefat" name="<?php echo esc_attr($this->get_field_name('social1')); ?>" type="text" value="<?php echo esc_attr($social1); ?>"></p>
        <p><label>Twitter/X URL:</label><input class="widefat" name="<?php echo esc_attr($this->get_field_name('social2')); ?>" type="text" value="<?php echo esc_attr($social2); ?>"></p>
        <p><label>Website URL:</label><input class="widefat" name="<?php echo esc_attr($this->get_field_name('social3')); ?>" type="text" value="<?php echo esc_attr($social3); ?>"></p>

        <p><label>Instagram URL:</label><input class="widefat" name="<?php echo esc_attr($this->get_field_name('social4')); ?>" type="text" value="<?php echo esc_attr($social4); ?>"></p>

        <p><label>Linkedin URL:</label><input class="widefat" name="<?php echo esc_attr($this->get_field_name('linkedin_url')); ?>" type="text" value="<?php echo esc_attr($linkedin_url); ?>"></p>
...
// REGISTER WIDGET
function kindaid_register_footer_info_widget() {
    register_widget('Kindaid_Footer_Info_Widget');
}
add_action('widgets_init', 'kindaid_register_footer_info_widget');
