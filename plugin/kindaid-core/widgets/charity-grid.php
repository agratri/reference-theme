<?php
class Kindaid_Charity_Grid extends \Elementor\Widget_Base {

	public function get_name(): string {
		return 'kindaid-charity-grid';
	}

	public function get_title(): string {
		return esc_html__( 'Charity Grid', 'kindaid-core' );
	}
	...
	protected function register_controls_section(){
		...
		$this->start_controls_section(
			'post_section',
			[
				'label' => esc_html__( 'Charity Grid', 'kindaid-core' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
				...
				<div class="col-xl-4 col-lg-6 col-md-6">
					<div class="tp-causes-wrap mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
						...
						<div class="tp-causes-content mb-35">
							...
							<div class="progress" role="progressbar" aria-label="Example with label" aria-valuenow="<?php echo esc_attr($percent); ?>" aria-valuemin="0" aria-valuemax="100">
								<div class="progress-bar wow slideInLeft" data-wow-duration="1s" data-wow-delay=".1s" style="width: <?php echo esc_attr($percent); ?>%"></div>
							</div>
							</div>
							<div class="row">
							<div class="col-6">
...
$widgets_manager->register( new Kindaid_Charity_Grid() );