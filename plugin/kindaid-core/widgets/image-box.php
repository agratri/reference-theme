...
class Kindaid_Image_Box extends \Elementor\Widget_Base {
	...
	public function get_name(): string {
		return 'kindaid-image-box';
	}

	public function get_title(): string {
		return esc_html__( 'Image Box', 'kindaid-core' );
	}
	...
	protected function render(): void {
		...
		<div class="tp-service-3-item fix icon-anime-wrap position-relative <?php echo esc_attr($wow_class); ?>" <?php echo $duration; ?> <?php echo $delay; ?>>
			<?php if(!empty($bg_image_url)) : ?>
			<div class="tp-service-3-thumb position-relative">
				<img class="img-100" src="<?php echo esc_url($bg_image_url); ?>" alt="<?php echo esc_attr($bg_image_alt); ?>">
			</div>
			<?php endif; ?>	
			...
			<h3 class="tp-service-title text-uppercase mb-15"><a href="<?php echo esc_url($settings['box_url']); ?>" class="common-underline"><?php echo kindaid_kses_svg($settings['title']); ?></a></h3>
			<?php else : ?>
				<h3 class="tp-service-title text-uppercase mb-15"><?php echo kindaid_kses_svg($settings['title']); ?></h3>
			<?php endif; ?>
			</div>
			<div class="tp-service-3-dec">
			<p class="mb-0"><?php echo kindaid_kses_svg($settings['description']); ?></p>
			</div>
		</div>
