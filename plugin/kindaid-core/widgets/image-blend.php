<?php
class Kindaid_Image_Blend extends \Elementor\Widget_Base {

	public function get_name(): string {
		return 'kindaid-img-blend';
	}

	public function get_title(): string {
		return esc_html__( 'Image Blend', 'kindaid-core' );
	}
	...
	protected function render(): void {
		...
		<div class="tp-cta-img tp-cta-img-2">
...
$widgets_manager->register( new Kindaid_Image_Blend() );