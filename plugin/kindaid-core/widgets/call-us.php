<?php
class Kindaid_Call_Us extends \Elementor\Widget_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Call Us', 'kindaid-core' );
	}
	...
	protected function register_controls_section(){
		...
		$this->add_control(
			'phone',
			[
				'label' => esc_html__( 'Phone', 'kindaid-core' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => esc_html__( '123456789', 'kindaid-core' ),
			]
		);
	...
	protected function render(): void {
		...
		<div class="tp-chose-thumb p-relative">
			...
			<div class="tp-chose-contact-info d-flex align-items-center">
				...
				<div class="tp-chose-contact-numbar">
					<span class="d-block"><?php echo esc_html($settings['sub_title']); ?></span>
					<a href="tel:<?php echo esc_attr($settings['phone']); ?>" class="common-underline"><?php echo esc_html($settings['phone']); ?></a>
				</div>
				<?php endif; ?>	
			</div>
		</div>
...
$widgets_manager->register( new Kindaid_Call_Us() );